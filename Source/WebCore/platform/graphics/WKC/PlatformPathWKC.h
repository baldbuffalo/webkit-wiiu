...
namespace WebCore {
    ...
    public:
        ...
        void strokePath(void*, const AffineTransform* tr) const;
        void fillPath(void*, const AffineTransform* tr) const;
        void clipPath(void*, const AffineTransform* tr) const;
        void clipOutPath(void*, const AffineTransform* tr) const;
        ...
        FloatRect boundingRectWithStyle(const GraphicsContext*) const;
    ...
    private:
        ...
        void drawPolygons(void* dc, const Vector<PathPolygon>& polygons, int type, const AffineTransform* transformation) const;
