...
/*@{*/
    ...
    */
    ...
    /**
       ...
       @return None
       @details
       Sets the directory to store application caches.
    */
    WKC_API void setApplicationCacheDirectory(const char* directory);
    /**
       @brief Sets application cache maximum size.
       @param size maximum size of application cache (bytes).
       @return None
       @details
       Sets the maximum size of application cache.
    */
    WKC_API void setApplicationCacheMaximumSize(wkc_int64 size);
    /**
    ...
    */
    ...
    /**
       @brief Sets the media player skin
       @param skin Pointer to WKCMediaSkin
       @retval None
       @details
