...
public:
    ...
    virtual void didFinishLoading(WebCore::ResourceHandle*, double);
    ...
    // WKC extension of ResourceHandleClient
    virtual bool willAcceptCookie(WebCore::ResourceHandle* handle, const WTF::String& firstparty_host, const WTF::String& cookie_domain);
    virtual bool willSendCookie(WebCore::ResourceHandle* handle, const WTF::String& firstparty_host, const WTF::String& cookie_domain);
    virtual bool isInclusionRequest();
    virtual bool willReceiveData(WebCore::ResourceHandle* handle, int length);
    ...
    virtual int  willPermitSendRequest(WebCore::ResourceHandle* handle, const char* url, bool isRoot, bool isSync);
...
void
WKCDownloadClientPrivate::didFinishLoading(WebCore::ResourceHandle*, double)
{
...
//
bool
WKCDownloadClientPrivate::willAcceptCookie(WebCore::ResourceHandle* handle, const WTF::String& firstparty_host, const WTF::String& cookie_domain)
{
    /* not implemented yet */
    return true;
}
...
bool
WKCDownloadClientPrivate::willSendCookie(WebCore::ResourceHandle* handle, const WTF::String& firstparty_host, const WTF::String& cookie_domain)
{
    /* not implemented yet */
    return true;
}
...
bool 
WKCDownloadClientPrivate::isInclusionRequest()
{
    return false;
}

bool 
WKCDownloadClientPrivate::willReceiveData(WebCore::ResourceHandle* ,int length)
{
    return m_download->notifyWillReceiveData(length);
}

void
WKCDownloadClientPrivate::notifySSLStateChange(WebCore::ResourceHandle* handle, int state)
{
    /* not implemented yet */
}

int
WKCDownloadClientPrivate::requestSSLClientCertSelect(WebCore::ResourceHandle* handle, const char* requester, void* certs, int num)
{
    /* not implemented yet */
    return -1;
}
...
int
WKCDownloadClientPrivate::willPermitSendRequest(WebCore::ResourceHandle* handle, const char* url, bool isRoot, bool isSync)
{
    /* not implemented yet */
    return 1;
}
