...
/**
@brief Queries whether the font engine supports suspending
@retval !=false font engine supports suspending
@retval ==false font engine doesn't support suspending
@details
Return whether the font engine can support suspending. The statis memory will be freed while suspending.
*/
WKC_PEER_API bool wkcFontEngineCanSuspendPeer(void);
...
*/
WKC_PEER_API int wkcFontGetAscentPeer(void* in_font);
/**
...
*/
WKC_PEER_API int wkcFontGetDescentPeer(void* in_font);
/**
...
*/
WKC_PEER_API int wkcFontGetLineSpacingPeer(void* in_font);
/**
...
*/
WKC_PEER_API int wkcFontGetLineGapPeer(void* in_font);
/**
...
*/
WKC_PEER_API int wkcFontGetXHeightPeer(void* in_font);
/**
...
*/
WKC_PEER_API int wkcFontGetAverageCharWidthPeer(void* in_font);
/**
...
*/
WKC_PEER_API int wkcFontGetMaxCharWidthPeer(void* in_font);
/**
...
*/
WKC_PEER_API int wkcFontGetTextWidthPeer(void* in_font, int in_flags, const unsigned short* in_str, int in_strlen, int* out_clip_width);
/**
...
*/
WKC_PEER_API int wkcFontDrawTextPeer(void* in_font, int in_flags, const unsigned short* in_str, int in_strlen,
                                 void* in_offscreen, const WKCSize* in_offscreensize,
                                 int in_rowbytes, int in_fmt,
                                 const WKCFloatRect* in_textbox, const WKCFloatRect* in_clip,
...
enum {
    ...
    // meter
    WKC_SKINCOLOR_METER_BORDER,
    WKC_SKINCOLOR_METER_BODY,
    WKC_SKINCOLOR_METER_BACKGROUND,
    WKC_SKINCOLOR_METER_BACKGROUND_DISABLED,
...
enum {
    WKC_OFFSCREEN_TYPE_RGBA5650 = 0,
    WKC_OFFSCREEN_TYPE_ARGB8888,
    WKC_OFFSCREEN_TYPE_POLYGON,
...
#define WKC_IMAGETYPE_RGAB5515           0x00000001
#define WKC_IMAGETYPE_RGAB5515MASK       0x00000002
...
WKC_PEER_API void wkcOffscreenSetBitmapPeer(void* in_offscreen, void* in_bitmap);
#endif
...
typedef bool (*wkcLayerCanAllocateProc)(int in_width, int in_height);
...
WKC_PEER_API void wkcLayerSetTexturePeer(void* in_layer, int in_texture);
...
WKC_PEER_API void wkcLayerGetZoomedSizePeer(void* in_layer, int* out_width, int* out_height);
...
#ifdef WKC_CUSTOMER_PATCH_0304674
WKC_PEER_API void wkcLayerSetOffscreenBitmapPeer(void* in_layer, void* in_bitmap);
#endif
...
WKC_PEER_API bool wkcLayerCanAllocatePeer(int in_width, int in_height);
